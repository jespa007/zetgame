...
$RASPBIAN_TOOLCHAIN/bin/arm-linux-gnueabihf-gcc -g -O0 test_window_rpi.c -ludev -lbcm_host -pthread -lbrcmGLESv2 -lbrcmEGL -lvcos -lvchiq_arm -lm -ldl -I${RASPBIAN_ROOTFS}/user/include -L${RASPBIAN_ROOTFS}/user/lib -I${RASPBIAN_ROOTFS}/opt/vc/include -L${RASPBIAN_ROOTFS}/opt/vc/lib -o test_window_rpi
