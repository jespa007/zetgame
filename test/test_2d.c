...
int main(int argc, char *argv[]){
	...
	do{
		...
		Graphics_DrawRectangleFilled4i(20,20,100,100,Color4f_FromHex(0xFFFF));
		Graphics_DrawRectangleTextured4i(200,200,100,100,COLOR4F_WHITE,text_png,NULL);
		Graphics_DrawRectangleTextured4i(300,300,100,100,COLOR4F_WHITE,text_jpg,NULL);
		Graphics_DrawRectangleTextured4i(100,200,100,100,COLOR4F_WHITE,text_default,NULL);
