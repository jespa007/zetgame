...
int main(int argc, char *argv[]){
	...
	do{
		...
		Graphics_DrawRectangleTextured4i(200,200,100,100,ZG_COLOR4F_WHITE,text_png,NULL);
		Graphics_DrawRectangleTextured4i(300,300,100,100,ZG_COLOR4F_WHITE,text_jpg,NULL);
		Graphics_DrawRectangleTextured4i(100,200,100,100,ZG_COLOR4F_WHITE,text_default,NULL);
		...
		for(int i=0; i<10;i++){
			ZG_Transform_SetPosition2i(&transform,rand()%Graphics_GetWidth(),rand()%Graphics_GetHeight());
