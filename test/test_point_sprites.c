...
void particles_setup(){
	...
	for(int i=0; i<MAX_PARTICLES; i++) {
		pos[i].pos[0] = -1;//unifRand(-1, 1);
		pos[i].pos[1] = 0;//unifRand(-1, 1);
		pos[i].pos[2] = 0;//unifRand(-1, 1);
		vel[i][0] = unifRand(-1, 1)*0.01f;
		vel[i][1] = unifRand(-1, 1)*0.01f;
		vel[i][2] = unifRand(-1, 1)*0.01f;
