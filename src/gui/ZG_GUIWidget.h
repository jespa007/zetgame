...
#define ZG_GUI_GET_RELATIVE_X(widget) (widget->position_local.x + widget->position_offset.x)
#define ZG_GUI_GET_RELATIVE_Y(widget) (widget->position_local.y + widget->position_offset.y)
...
typedef enum{
	ZG_GUI_WIDGET_POSITION_LOCAL=0,
	ZG_GUI_WIDGET_POSITION_WORLD,
	ZG_GUI_WIDGET_POSITION_SCREEN
