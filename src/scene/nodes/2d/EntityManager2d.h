...
public:
	...
	void setupAsTextBoxNode2d(uint8_t max_texts,const std::string & font, uint8_t size,const CColor3i & color);
	void setupAsTextBoxNode2d(uint8_t max_texts,const std::string & font, uint8_t size,const CColor3i & color, unsigned short properties);
