...
typedef struct{
	...
	ZG_EntityType	* 	em_sg_nodes;
	ZG_EntityType	* 	em_sg_textures;
	ZG_EntityType	* 	em_sg_textboxes;
...
Scene * Scene_New(void){
	...
	data->em_sg_nodes=ZG_EntitySystem_NewEntityType(
		data->entity_system
		,"sg_nodes"
		,MAX_SG_NODES
	...
	data->em_sg_textures=ZG_EntitySystem_NewEntityType(
	...
	data->em_sg_textboxes=ZG_EntitySystem_NewEntityType(
...
ZG_EntityType * Scene_NewEntityType(
		Scene *_this
		, const char *_id
	...
	SceneData *data=_this->data;
	return ZG_EntitySystem_NewEntityType(data->entity_system,_id,max_entities,entity_components,entity_components_len);
}
...
ZG_Entity * Scene_NewEntityFromManager(Scene *_this, const char *_str_archetype){
	SceneData *data=_this->data;
	return EntitySystem_NewEntityFromManager(data->entity_system,_str_archetype);
}
*/
