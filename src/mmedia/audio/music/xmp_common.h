...
#ifdef _MSC_VER				/* MSVC++6.0 has no uint32_t uint32_t */
...
#define QUIRK_VIRTUAL	(1 << 15)	/* Enable virtual keyframe_tracks */
...
/* Time factor */
#define XMP_DEFAULT_TIME_FACTOR	10.0
#define XMP_MED_TIME_FACTOR		2.64

#define XMP_MAX_SEQUENCES		16
#define XMP_MAX_SAMPLE_SIZE		0x10000000
#define XMP_MAX_SAMPLES			1024

#define XMP_READ_EVENT_MOD	0
#define XMP_READ_EVENT_FT2	1
#define XMP_READ_EVENT_ST3	2
#define XMP_READ_EVENT_IT	3
#define XMP_READ_EVENT_MED	4
...
struct module_data {
	...
	int num_sequences;
	struct xmp_sequence seq_data[XMP_MAX_SEQUENCES];
...
struct player_data {
	...
	struct virt_control {
		int num_tracks;		/* Number of keyframe_tracks */
		int virt_channels;	/* Number of virtual keyframe_tracks */
