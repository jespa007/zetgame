#ifndef __ZG_VECTOR3F_H__
#define __ZG_VECTOR3F_H__
...
ZG_Vector3f  ZG_Vector3f_Ones(void);
ZG_Vector3f  ZG_Vector3f_New3f(float x, float y, float z);
ZG_Vector3f  ZG_Vector3f_Zeros(void);
ZG_Vector3f  ZG_Vector3f_Instance3f(float x, float y, float z);
