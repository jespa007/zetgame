...
int					ESSystem_RegisterComponent(ESSystemRegisterComponent es_component_register);
...
void 			*	ESSystem_NewEntityType(ESSystem *_this, const char *_str_entity_type,unsigned * entity_components, size_t entity_components_len);
