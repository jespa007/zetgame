...
/*get the amount of color keyframe_tracks used, based on colortype in the struct.
...
*) support for alpha keyframe_tracks, including RGBA color model, translucent palettes and color keying
...
is easy, but there are multiple ways if you want to give some keyframe_tracks more
weight).
...
of bits per pixel is: amount of keyframe_tracks * bitdepth.
...
three keyframe_tracks are the same in this case so ignores green and blue). The reason
